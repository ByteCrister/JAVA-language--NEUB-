    ...
    Listener1() {
        ...
        jt1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if(text.isEmpty()){
                    JOptionPane.showMessageDialog(null, "You did not entered anything","WARNING",JOptionPane.ERROR_MESSAGE);

                }else{
                    JOptionPane.showMessageDialog(null, "You have entered : "+text, "Your Text", JOptionPane.PLAIN_MESSAGE);
                }
            }
        });
