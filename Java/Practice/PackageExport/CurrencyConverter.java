...
public class CurrencyConverter extends javax.swing.JFrame {
    ...
    double Bangladeshi_Taka = 137.05;
    double Indian_Rupee = 103.56;
    double European_Euro = 1.15;
    double Saudi_Riyal = 4.69;
    ...
    String[] currencyUnits = { "Units", "US Dollar", "Bangladeshi Taka", "Indian Rupee", "European Euro", "Saudi Riyal",
            "Australian Dollar", "Brazilian Real", "Canadian Dollar", "Kenyan Shilling", "Indonesian Rupiah",
            "Nigerian Naira", "Philippine Peso", "Pakistani Rupee" };
    ...
    private void initComponents() {
        ...
        firstCountry.setModel(new javax.swing.DefaultComboBoxModel<>(
                new String[] { "Choose One...", "USA", "Bangladesh", "India", "Europe", "Saudi Arab", "Australia",
                        "Brazil", "Canada", "Kenyan", "Indonesia", "Nigeria", "Philippine", "Pakistan" }));
        ...
        secondCountry.setModel(new javax.swing.DefaultComboBoxModel<>(
                new String[] { "Choose One...", "USA", "Bangladesh", "India", "Europe", "Saudi Arab", "Australia",
                        "Brazil", "Canada", "Kenyan", "Indonesia", "Nigeria", "Philippine", "Pakistan" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (firstCountry.getSelectedItem().equals("Choose One...")
                || secondCountry.getSelectedItem().equals("Choose One...") || t1.getText().isEmpty()) {
        ...
        switch (firstCountry.getSelectedItem().toString()) {
            ...
            case "India":
                ...
                break;
            case "Europe":
                amountInPounds = amountToChange / European_Euro;
                break;
            case "Saudi Arab":
        ...
        switch (secondCountry.getSelectedItem().toString()) {
            ...
            case "India":
                ...
                break;
            case "Europe":
                amountChanged = amountInPounds * European_Euro;
                break;
            case "Saudi Arab":
